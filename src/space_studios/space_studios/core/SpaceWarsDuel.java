...
final SpaceWarsCore core;
	...
	//ship costs
	public static int blueSuicideCost = 5;
	public static int blueShooterCost = 10;
	public static int blueBlockerCost = 15;
	public static int redSuicideCost = 5;
	public static int redShooterCost = 10;
	public static int redBlockerCost = 15;
		...
		if (W==true){
			for(int len = allBShips.size(), i = 0; i < len; i++) {
				...
				if (ship.getType().equals(ShipTypes.ShooterShip)){
					//if you have enough money for it
					if (blueMoney>=blueShooterCost){	
						//if its create function returns true, break
						if (ship.create(blueSelected,0)==true){
							W=false;
							Statistics.blueShooterShipCreation += 1;
							blueMoney-=blueShooterCost;
		...
		if (E==true){
			for(int len = allBShips.size(), i = 0; i < len; i++) {
				...
				if (ship.getType().equals(ShipTypes.BlockerShip)){
					//if you have enough money for it
					if (blueMoney>=blueBlockerCost){	
						//if its create function returns true, break
						if (ship.create(blueSelected,0)==true){
							E=false;
							Statistics.blueBlockerShipCreation += 1;
							blueMoney-=blueBlockerCost;
